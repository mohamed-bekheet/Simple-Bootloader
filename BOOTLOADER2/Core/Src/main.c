...
/**
  ...
  *                             www.st.com/SLA0044
  *
  *   This a simple bootloader to switch to another application
  *
  ******************************************************************************
  */
...
#define APP_START_FLASH_ADDRESS       (uint32_t*)0x8002800 //After 10KB of Bootloader
typedef (*ptrF)(void); //pointer to function
/* Private includes ----------------------------------------------------------*/
...
void BL_SWITCH_TO_APP(void ){
	...
	if(((*(uint32_t*) APP_START_FLASH_ADDRESS)  & 0x2FFE0000) == 0x20000000)
	{
		printf("APP Start ...\r\n");
		HAL_Delay(100);
